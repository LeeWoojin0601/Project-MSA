...
CREATE TABLE `product` (
    ...
    CONSTRAINT `fk_product_factory_id` FOREIGN KEY (`factory_id`) REFERENCES `factory` (`factory_id`),
    CONSTRAINT `fk_product_ad_id` FOREIGN KEY (`ad_id`) REFERENCES `advertisement` (`ad_id`)
);
